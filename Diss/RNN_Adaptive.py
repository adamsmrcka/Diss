...
# Here, we'll treat each feature vector as a sequence of time steps with one feature per step.
...
# Add SimpleRNN layer
model.add(SimpleRNN(units=16, activation='relu', input_shape=(X_train.shape[1], X_train.shape[2])))
